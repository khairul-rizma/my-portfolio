...
const Hero = () => {
    ...
    return (
        ...
        `,
            ...
            <div className="hero-deco-num" style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ width: '32px', height: '1px', background: '#D4AF37', flexShrink: 0 }} />
                    <span style={{
                ...
                <div style={{
                    ...
                    <button onClick={scrollToContact} style={{
                        ...
                        onMouseEnter={e => { e.target.style.background = 'rgba(212,175,55,0.08)'; e.target.style.transform = 'translateY(-2px)' }}
                ...
                <div style={{
                    ...
                    <span style={{
                        ...
                        letterSpacing: '0.25em', color: '#555', textTransform: 'uppercase',
                    }}>Scroll</span>
                    <div style={{
